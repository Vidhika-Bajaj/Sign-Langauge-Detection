...
while True:
    ...
    count = {
             ...
             'A': len(os.listdir(directory+"/1")),
             'B': len(os.listdir(directory+"/2")),
             'C': len(os.listdir(directory+"/3")),
             'D': len(os.listdir(directory+"/4")),
             'E': len(os.listdir(directory+"/5")),    
    ...
    if interrupt & 0xFF == ord('A'):
        cv2.imwrite(directory+'1/'+str(count['A'])+'.png',frame)
    if interrupt & 0xFF == ord('B'):
        cv2.imwrite(directory+'2/'+str(count['B'])+'.png',frame)
    if interrupt & 0xFF == ord('C'):
        cv2.imwrite(directory+'3/'+str(count['C'])+'.png',frame)
    if interrupt & 0xFF == ord('D'):
        cv2.imwrite(directory+'4/'+str(count['D'])+'.png',frame)
    if interrupt & 0xFF == ord('E'):
        cv2.imwrite(directory+'5/'+str(count['E'])+'.png',frame)
